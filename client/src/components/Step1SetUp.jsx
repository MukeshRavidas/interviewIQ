            ...
            <div className="w-full max-w-6xl bg-white rounded-3xl
             shadow-2xl grid md:grid-cols-2 overflow-hidden">
                ...
                <motion.div
                 ...
                 from-green-50 to-green-50 p-12 flex flex-col
                  justify-center">
                    ...
                    <div className="space-y-6">
                        ...
                        {!analysisDone && (
                            <motion.div
                                ...
                                <FaUpload className="text-4xl mx-auto text-green-600
                                     mb-3"/>
                                <input type="file"
                                ...
                                <h3 className="text-lg font-semibold text-gray-800">
                                    ...
                                    {projects.length > 0 && (
                                        <div>
                                            ...
                                            Projects:</p>
                                            <ul className="list-disc list list-inside text-gray-600
                                             space-y-1">
                                                {projects.map((p,i)=>(
                                                    <li key={i}>{p}</li>
                                                ))}
                        ...
                        <motion.button
                         ...
                         hover:bg-green-700 text-white py-3 rounded-full text-lg font-bold
