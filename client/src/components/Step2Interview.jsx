...
function Step2Interview({ interviewData, onFinish }) {
    ...
    useEffect(() => {
        ...
        const runIntro = async () => {
            if (isIntroPhase) {
                ...
                if (currentQuestionIndex === questions.length - 1) {
                    await speakText("Alright, this one might be a bit more challanging.");
        ...
        runIntro();
    }, [selectVoice, isIntroPhase, currentQuestionIndex])
    ...
    }, [isIntroPhase, currentQuestionIndex, isSubmitting])
    ...
    const handleNext = async () => {
        ...
        setTimeLeft(
            questions[currentQuestionIndex + 1]?.timeLimit || 60
        );
    ...
    return (
        <div className="min-h-screen bg-linear from-emerald-50 via-white
              ...
              overflow-hidden">
                ...
                <div className="w-full lg:w-[35%] bg-white flex flex-col items-center
                 p-6 space-y-6 border-r border-gray-200">
                    ...
                    {subtitle && (<div className="w-full max-w-md bg-gray-50 border border-gray-200
                    ...
                    <div className="w-full max-w-md bg-white border border-gray-200
                     rounded-2xl shadow-md p-6 space-y-5">
                        ...
                        <div className="flex justify-center">
                            <Timer timeLeft={timeLeft} totalTime={currentQuestion?.
                                timeLimit} />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 text-center">
                            <div>
                                ...
                                <span className="text-xs text-shadow-gray-400">Current Questions</span>
                            </div>
                            ...
                            <div>
                                ...
                                <span className="text-xs text-shadow-gray-400">Total Questions</span>
                            </div>
                        </div>
                    </div>
                </div>
